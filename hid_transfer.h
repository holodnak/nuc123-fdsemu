/******************************************************************************
 * @file     hid_transfer.h
 * @brief    NUC123 series USB HID transfer header file
 *
 * @note
...
#define HID_DEFAULT_INT_IN_INTERVAL     0xA
#define USBD_SELF_POWERED               0
#define USBD_REMOTE_WAKEUP              0
#define USBD_MAX_POWER                  0x3C  /* The unit is in 2mA. ex: 50 * 2mA = 100mA */
