...
typedef uint8_t *(*GET_HID_RPT_CB)(int32_t i32IfNum, uint32_t *pu32Size);  /*!< Functional pointer type declaration for USB get HID report descriptor request callback handler */
