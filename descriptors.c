...
const uint8_t HID_DeviceReportDescriptor[] = {
    ...
    0x85, ID_SPI_VERIFY,           //   REPORT_ID (4)
    0x09, 0x01,                    //   USAGE (Vendor Usage 1)
    0x95, 0x3f,                    //   REPORT_COUNT (63)
    0xb1, 0x00,                    //   FEATURE (Data,Ary,Abs)

    0x85, ID_SRAM_WRITE,           //   REPORT_ID (5)
    0x09, 0x01,                    //   USAGE (Vendor Usage 1)
    0x95, 0x3f,                    //   REPORT_COUNT (63)
    0xb1, 0x00,                    //   FEATURE (Data,Ary,Abs)

    0x85, ID_SRAM_TRANSFER,        //   REPORT_ID (9)
    0x09, 0x01,                    //   USAGE (Vendor Usage 1)
    0x95, 0x03,                    //   REPORT_COUNT (63)
    0xb1, 0x00,                    //   FEATURE (Data,Ary,Abs)

    0x85, ID_SRAM_TRANSFER_START,  //   REPORT_ID (9)
    0x09, 0x01,                    //   USAGE (Vendor Usage 1)
    ...
    0x85, ID_BOOTLOADER_VERIFY,    //   REPORT_ID ()
    0x09, 0x01,                    //   USAGE (Vendor Usage 1)
    0x95, 0x05,                    //   REPORT_COUNT (1)
    0xb1, 0x00,                    //   FEATURE (Data,Ary,Abs)

    0x85, ID_BOOTLOADER_UPDATE,    //   REPORT_ID ()
    0x09, 0x01,                    //   USAGE (Vendor Usage 1)
    0x95, 0x01,                    //   REPORT_COUNT (1)
    0xb1, 0x00,                    //   FEATURE (Data,Ary,Abs)
    ...
    0x85, ID_SELFTEST,             //   REPORT_ID (242)
    0x09, 0x01,                    //   USAGE (Vendor Usage 1)
    0x95, 0x01,                    //   REPORT_COUNT (1)
    0xb1, 0x00,                    //   FEATURE (Data,Ary,Abs)
